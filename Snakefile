...
RECOMBINANT_CLADES =    ["C","D","E","F"]  # clades treated as recombinant forms (RFs)
...
VIRUS_ABBREV =           "CVA16"    # short abbreviation for the target virus, used in test sequence labels/filenames
